      ...
      if(this.readyState == this.HEADERS_RECEIVED) {
        ...
        if (!antiSpamWarned && contentType == "WARN") {
            ...
            Swal.fire({
                icon: "warning",
                title: "Anti-spam",
                html: "<b>Avertissement</b><br>Vous envoyez trop de requête au serveur. Votre adresse a été placée en liste d'avertissement, si vous en envoyez trop sur une trop longue durée, votre adresse IP sera blacklistée.",
        ...
        if (!antiSpamBanned && contentType == "BAN") {
            ...
            Swal.fire({
                icon: "error",
                title: "Anti-spam",
                html: "<b>IP blacklistée</b><br>Vous avez envoyé trop de requête au serveur et votre adresse IP a été blacklistée. Envoyez un message aux administrateurs pour que votre adresse soit réautorisée.",
                footer: '<div class="alert alert-warning" role="alert">Veillez à n\'ouvrir qu\'un nombre strictement nécessaire d\'onglets.</div>',
            })  
        }
